...
- Digest watching is on by default so `:latest` Saltbox images still report when the digest moves
...
| `WUD_WATCHER_LOCAL_WATCHDIGESTDEFAULT` | `true` | Digest fallback for non-semver tags |
